...
func newOperatorTestCommand() (*cobra.Command, error) {
	...
	cmd := &cobra.Command{
		Use:   "lws-operator-tests",
		Short: "A binary used to run lws-operator tests as part of OTE.",
...
func prepareOperatorTestsRegistry() (*oteextension.Registry, error) {
	...
	extension := oteextension.NewExtension("openshift", "payload", "lws-operator")
	...
	// Tests tagged with [Operator] included in this suite.
